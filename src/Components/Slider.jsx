...
const sliderTexts = [
  {
    title: "Where Is It?",
    subtitle: "Post lost items, find found ones, stay connected.",
    caption: "A small post can bring back big memories.",
  },
  {
    title: "Find and Be Found",
    subtitle: "Lost something? Report and let others help.",
    caption: "Someone out there might have found what you lost.",
  },
  {
    title: "Community Helping Community",
    subtitle: "Together, we recover faster.",
    caption: "One post can make someone’s day better.",
  },
];
